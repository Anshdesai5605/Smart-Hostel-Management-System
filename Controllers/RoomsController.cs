...
namespace SmartHostelManagementSystem.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomNo,Capacity,OccupiedCount")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomNo,Capacity,OccupiedCount")] Room room)
        {
            if (id != room.RoomNo)
            {
                return NotFound();
